    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch("/api/settings", {
                ...
                body: JSON.stringify({ aboutText, phone, email, address })
            });
        ...
        <div className={styles.adminMain}>
            ...
            <div className={styles.card} style={{ backgroundColor: "white", padding: "2rem", borderRadius: "8px", border: "1px solid var(--gray-200)" }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                    ...
                    <div>
                        <label style={{ display: "block", marginBottom: "0.5rem", fontWeight: "600", color: "var(--gray-700)" }}>Hakkımızda Yazısı (HTML formatı desteklenir)</label>
